...
class Trip:
    ...
    def get_all(cls) -> list:
        ...
        for trip in results:
            this_trip = cls(trip)
            user_data = {
                'id': this_trip['users.id'],
                'first_name': this_trip['first_name'],
                'last_name': this_trip['last_name'],
                'email': this_trip['email'],
                'created_at': this_trip['users.created_at'],
                'updated_at': this_trip['users.updated_at'],
            }
